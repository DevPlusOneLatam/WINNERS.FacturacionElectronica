CREATE PROCEDURE PLUS_FE_SP_LISTA_DOCUMENTO
AS BEGIN
...
"EMISOR_DISTRITO"		= UPPER(ISNULL(T21."County",'')),
"EMISOR_PROVINCIA"		= UPPER(ISNULL(T21."City",'')),
...
"RECEPTOR_DISTRITO"		= UPPER(LEFT(ISNULL(T3."CountyB",ISNULL(T11."County",'')),100)),
...
"RECEPTOR_UBIGEO"		= ISNULL(T3."GlbLocNumB",''),
...
"EMISOR_DIRECCION"		= UPPER(LEFT(ISNULL(CONCAT(T21."Street" , ' ',T21."StreetNo",' ',T21."City", ' ',T21."County", ' ',T22."Name"),''),500)),
"EMISOR_CALLE"			= UPPER(LEFT(ISNULL(T21."Street",''),500)),
"EMISOR_URBANIZACION"	= UPPER(ISNULL(LEFT(ISNULL(T21."Block",''),30),'')),
"EMISOR_DISTRITO"		= UPPER(ISNULL(T21."County",'')),
"EMISOR_PROVINCIA"		= UPPER(ISNULL(ISNULL(T21."City",''),'')),
"EMISOR_DEPARTAMENTO"	= UPPER(ISNULL(ISNULL(T22."Name",''),'')),
"EMISOR_PAIS"			= 'PERU',--UPPER(T20."Country"),
"EMISOR_UBIGEO"			= ISNULL(T21."GlblLocNum",''),
